...
Shader "Unity Shaders Book/Chapter 14/Hatching"
{
    Properties
    {
        ...
        _TileFactor ("Tile Factor", Float) = 1 // 纹理平铺系数 越大 素描线条越密 
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(a2v v)
            {
                ...
                // 使用世界空间下的光照方向和法线方向 得到漫反射系数
                fixed diff = max(0, dot(worldLightDir, worldNormal));

                o.hatchWeights0 = fixed3(0, 0, 0);
                o.hatchWeights1 = fixed3(0, 0, 0);

                float hatchFactor = diff * 7.0; // 把系数缩放到 [0,7]范围内
            ...
            {
                // 对每张纹理进行采样并和对应的权重相乘 得到每个纹理的采样颜色
