Shader "Hidden/Special/LaserTransparent"
{
    Properties
    {
        ...
        [Toggle(_DISABLEREFLECT_ON)] _DisableReflect("DisableReflect", Float) = 0
        _ReflectHueScaleOffset("ReflectHueScaleOffset", Vector) = (1,0,0,0)
        _ReflectAlpha("ReflectAlpha", Range( 0 , 1)) = 0.8
        _ReflectIndirect("ReflectIndirect", Range( 0 , 1)) = 1
        _Specular("Specular", Range( 0 , 2)) = 1
        _SpecularPower("SpecularPower", Range( 0.1 , 50)) = 1
    ...
    SubShader
    {
        ...
        UsePass "LaserMultiplyPass/Forward"
        ...
        Pass
        {
            ...
            half4 frag(VertexOutput IN) : SV_Target
            {
                ...
                float3 Color = (((_ReflectIndirect * bakedGI53 * ReflectColor58) + (ReflectColor58 * _MainLightColor.rgb
                    * saturate(pow(abs((dotResult41 * 0.5 + 0.5) * _Specular), _SpecularPower)))) * _ReflectAlpha);
                float Alpha = 1;
