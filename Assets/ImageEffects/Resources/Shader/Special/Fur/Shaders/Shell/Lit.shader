Shader "Hidden/Special/FurShellLit"
{
    ...
    Properties
    {
        ...
        _NormalScale("Normal Scale", Range(0.0, 2.0)) = 0.2
        [IntRange] _ShellAmount("Shell Amount", Range(1, 14)) = 14
        _ShellStep("Shell Step", Range(0.0, 0.01)) = 0.004
        _AlphaCutout("Alpha Cutout", Range(0.0, 1.0)) = 0.2
        _FurScale("Fur Scale", Range(0.0, 10.0)) = 2.0
        _Occlusion("Occlusion", Range(0.0, 1.0)) = 0.3
        _BaseMove("Base Move", Vector) = (0.0, -0.0, 0.0, 3.0)
        _WindFreq("Wind Freq", Vector) = (1.0, 0.4, 0.9, 1.0)
        _WindMove("Wind Move", Vector) = (0.5, 0.0, 0.2, 1.0)
