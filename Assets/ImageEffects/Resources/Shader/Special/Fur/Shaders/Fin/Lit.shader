Shader "Hidden/Special/FurFinLit"
{
    ...
    Properties
    {
        ...
        _FinLength("Length", Range(0.0, 1.0)) = 0.3
        _Density("Density", Range(0.1, 10.0)) = 2.0
        _FaceViewProdThresh("Direction Threshold", Range(0.0, 1.0)) = 1
