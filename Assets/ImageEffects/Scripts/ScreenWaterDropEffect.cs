...
namespace UnityStandardAssets.ImageEffects
{
    ...
    [AddComponentMenu ("Image Effects/ScreenWaterDropEffect")]
    public class ScreenWaterDropEffect : MonoBehaviour
    {
        ...
        //可以在编辑器中调整的参数值
        [Range(5, 64), Tooltip("溶解度")] public float Distortion = 8.0f;
        [Range(0, 7), Tooltip("水滴在X坐标上的尺寸")] public float SizeX = 1f;
        [Range(0, 7), Tooltip("水滴在Y坐标上的尺寸")] public float SizeY = 0.5f;
        [Range(0, 10), Tooltip("水滴的流动速度")] public float DropSpeed = 3.6f;
        ...
        void Update()
        {
            ...
            {
                CurShader = Shader.Find("Hidden/ScreenWaterDrop");
                ScreenWaterDropTex = Resources.Load("ScreenWaterDrop") as Texture2D;
            }
#endif
        }
